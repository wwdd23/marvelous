...
listen "/tmp/marvelous_peach.sock", :backlog => 64
...
# unicorn master pid
# unicorn pid 存放路径
pid APP_PATH + "/tmp/pids/unicorn_data.pid"

# unicorn 日志
stderr_path APP_PATH + "/log/unicorn_data.stderr.log"
stdout_path APP_PATH + "/log/unicorn_data.stdout.log"
